...
server {
    listen 80;
    server_name ayeshaubuntu.unmashable.online;
...
# Get HTTPS cert
certbot --nginx -d ayeshaubuntu.unmashable.online --non-interactive --agree-tos -m aisha.salman03@gmail.com || echo "Certbot failed — run it manually later"
