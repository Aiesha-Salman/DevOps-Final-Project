...
if [ ! -d "reactapp" ]; then
  sudo -u ec2-user git clone https://github.com/Aiesha-Salman/reactapp.git
fi
...
server {
    listen 80;
    server_name ayeshal2023.unmashable.online;
...
sudo certbot --nginx -d ayeshal2023.unmashable.online --non-interactive --agree-tos -m aisha.salman03@gmail.com
