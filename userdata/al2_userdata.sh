...
if [ ! -d "reactapp" ]; then
  git clone https://github.com/Aiesha-Salman/reactapp.git
fi
...
server {
    listen 80;
    server_name ayeshal2.unmashable.online;
...
sudo certbot --nginx -d ayeshal2.unmashable.online --non-interactive --agree-tos -m ayesha.salman03@gmail.com
